...
const rslidy_favicon_icon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">    <rect x="10" y="20" width="80" height="60" fill="none" stroke="black" stroke-width="5"/>    <rect x="20" y="30" width="60" height="40" fill="none" stroke="black" stroke-width="5"/>    <text x="50" y="54" text-anchor="middle"          dominant-baseline="middle" font-family="sans-serif" font-size="32">R</text></svg>`;
const rslidy_sorting_asc_icon = (/* unused pure expression or super */ null && (`<svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 320 512.29">  <!-- Top triangle filled blue -->  <path fill-rule="nonzero" d="M51.49 169.41h218.18L163.39 40.96 51.49 169.41z"/>  <!-- Rest unchanged -->  <path fill-rule="nonzero" d="M16.1 310.66h287.79c8.9 0 16.11 7.21 16.11 16.11 0 4.18-1.59 7.98-4.2 10.85L176.1 506.46c-5.66 6.85-15.82 7.8-22.66 2.14l-1.88-1.83L3.96 337.34c-5.84-6.7-5.14-16.88 1.57-22.71a16.09 16.09 0 0 1 10.57-3.97zm253.57 32.22H51.49l111.9 128.45 106.28-128.45zm34.22-141.25H16.1c-3.75 0-7.52-1.31-10.57-3.96-6.71-5.84-7.41-16.01-1.57-22.72L151.55 5.52l1.89-1.83c6.84-5.66 17-4.7 22.66 2.14l139.7 168.84c2.61 2.87 4.2 6.68 4.2 10.85 0 8.9-7.21 16.11-16.11 16.11z"/></svg>`));
const rslidy_sorting_base_icon = (/* unused pure expression or super */ null && (`<svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 320 512.29"><path fill-rule="nonzero" d="M51.49 169.41h218.18L163.39 40.96 51.49 169.41zM16.1 310.66h287.79c8.9 0 16.11 7.21 16.11 16.11 0 4.18-1.59 7.98-4.2 10.85L176.1 506.46c-5.66 6.85-15.82 7.8-22.66 2.14l-1.88-1.83L3.96 337.34c-5.84-6.7-5.14-16.88 1.57-22.71a16.09 16.09 0 0 1 10.57-3.97zm253.57 32.22H51.49l111.9 128.45 106.28-128.45zm34.22-141.25H16.1c-3.75 0-7.52-1.31-10.57-3.96-6.71-5.84-7.41-16.01-1.57-22.72L151.55 5.52l1.89-1.83c6.84-5.66 17-4.7 22.66 2.14l139.7 168.84c2.61 2.87 4.2 6.68 4.2 10.85 0 8.9-7.21 16.11-16.11 16.11z"/></svg>`));
const rslidy_sorting_desc_icon = (/* unused pure expression or super */ null && (`<svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 320 512.29">  <!-- Filled space between top triangles (outer rounded, inner sharp) -->  <path stroke-width="1" d="M303.89 201.63H16.1c-3.75 0-7.52-1.31-10.57-3.96-6.71-5.84-7.41-16.01-1.57-22.72L151.55 5.52l1.89-1.83c6.84-5.66 17-4.7 22.66 2.14l139.7 168.84c2.61 2.87 4.2 6.68 4.2 10.85 0 8.9-7.21 16.11-16.11 16.11z M51.49 169.41h218.18L163.39 40.96 51.49 169.41z"/>  <!-- Bottom triangle, filled black with black border -->  <path stroke-width="1" d="M269.67 342.88H51.49l111.90 128.45 106.28-128.45z"/>  <!-- Diamond (middle connection), filled black with black border -->  <path stroke-width="1" d="M16.1 310.66h287.79c8.9 0 16.11 7.21 16.11 16.11 0 4.18-1.59 7.98-4.2 10.85L176.1 506.46c-5.66 6.85-15.82 7.8-22.66 2.14l-1.88-1.83L3.96 337.34c-5.84-6.7-5.14-16.88 1.57-22.71a16.09 16.09 0 0 1 10.57-3.97z"/></svg>`));
...
class SettingsComponent {
    ...
    // ---
    generateJSON() {
        const themeSelect = this.view.querySelector("#rslidy-select-theme"); // declare it here
        const data = {
    ...
    setupTableSorting() {
        ...
        const sortTable = (tbody, columnIndex, direction) => {
            ...
            rows.sort((a, b) => {
                var _a, _b;
                const cellA = ((_a = a.children[columnIndex]) === null || _a === void 0 ? void 0 : _a.textContent) || "";
                const cellB = ((_b = b.children[columnIndex]) === null || _b === void 0 ? void 0 : _b.textContent) || "";
        ...
        tables.forEach((table) => {
            ...
            headers.forEach((header, columnIndex) => {
                ...
                const updateCursorAndTitle = (evt) => {
...
class ContentComponent {
    constructor(view) {
        ...
        document.addEventListener("keydown", (event) => {
            ...
            const current_index = this.currentSlideIndex >= 0 ? this.currentSlideIndex : this.getCurrentSlideIndex();
    ...
    getNumIncrItems(slide_index, only_visible) {
        ...
        var incremental_items = slide.querySelectorAll("ul.rslidy-incremental li");
    ...
    showItemsUpToN(n) {
        ...
        var incr_items = current_slide.querySelectorAll("ul.rslidy-incremental li");
...
function start() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield window.rslidy.loadRslidyTheme();
        setTimeout(() => {
            window.rslidy.init();
            const spinner = document.getElementById('rslidy-spinner');
            if (spinner)
                spinner.classList.add('rslidy-hidden');
...
var __webpack_exports__Rslidy = __webpack_exports__.o;
export { __webpack_exports__Rslidy as Rslidy };
